...
import { NotesDetailsComponent } from 'app/modules/admin/apps/memos/details/details.component';
import { NotesLabelsComponent } from 'app/modules/admin/apps/memos/labels/labels.component';
...
export class NotesListComponent implements OnInit, OnDestroy
{
    ...
    allNotesForUser() {
        this.noteService.getAllNotesForUser(this.userId).subscribe({
          next: (notes) => {
            this.allNotes =notes;
