...
import { TasksDetailsComponent } from 'app/modules/admin/apps/task-management/details/details.component';
import { TasksListComponent } from 'app/modules/admin/apps/task-management/list/list.component';
import { TasksComponent } from 'app/modules/admin/apps/task-management/tasks.component';
...
const taskResolver = (route: ActivatedRouteSnapshot, state: RouterStateSnapshot) =>
{
    ...
    return tasksService.getTaskById(Number(route.paramMap.get('id')))
        .pipe(
    ...
    nextState: RouterStateSnapshot) =>
{
    ...
    // tasks app
    if ( !nextState.url.includes('/task-management') )
    {
        // Let it navigate
        return true;
    }
