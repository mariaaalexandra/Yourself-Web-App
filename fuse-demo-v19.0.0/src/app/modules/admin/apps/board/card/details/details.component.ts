...
import { Board, Card, Label } from 'app/modules/admin/apps/board/scrumboard.models';
    ...
    ngOnInit(): void
    {
        ...
        this.cardForm.valueChanges
            ...
            .subscribe((value) =>
            {
                ...
                this._scrumboardService.updateCard(value.id, value, this.card.boardId, this.card.listId).subscribe();
