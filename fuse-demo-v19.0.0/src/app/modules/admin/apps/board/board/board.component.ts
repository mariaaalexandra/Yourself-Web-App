...
import { Board, Card, List } from 'app/modules/admin/apps/board/scrumboard.models';
...
export class ScrumboardBoardComponent implements OnInit, OnDestroy
{
    ...
    deleteList(list:List): void
    {
        ...
        confirmation.afterClosed().subscribe((result) =>
        {
            ...
            {
                // Delete the list
                this._scrumboardService.deleteList(list).subscribe();
            }
        });
    }
     ...
     */
      deleteTheCard(card:Card): void
      {
          ...
          confirmation.afterClosed().subscribe((result) =>
          {
              ...
              {
                  // Delete the list
                  this._scrumboardService.deleteCardd(card.boardId,card.listId,card.id).subscribe();
              }
          });
      }
    ...
    cardDropped(event: CdkDragDrop<Card[]>): void
    {
        ...
        else
        {
            ...
            event.container.data[event.currentIndex].listId = Number(event.container.id);
        }
