...
import { AcademyComponent } from 'app/modules/admin/apps/ebook/academy.component';
import { AcademyService } from 'app/modules/admin/apps/ebook/academy.service';
import { AcademyDetailsComponent } from 'app/modules/admin/apps/ebook/details/details.component';
import { AcademyListComponent } from 'app/modules/admin/apps/ebook/list/list.component';
