    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'apps', children: [
                ...
                {path: 'budget-tracker', loadChildren: () => import('app/modules/budget-tracker/bugdet-tracker.routes')},
                {path: 'budget-tracker/wallet', loadChildren: () => import('app/modules/budget-tracker/wallet.routes')},
